...
insert into author (age, name, genre, id) values (37, "Larisa Tomay", "History", 6);
...
insert into book (isbn, title, price, author_id, id) values ("001-OG", "Carrie", 33, 2, 3);
insert into book (isbn, title, price, author_id, id) values ("001-null", "Lost book", 0, null, 4);
