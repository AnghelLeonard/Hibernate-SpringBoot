...
insert into book (isbn, title, price, author_id, id) values ("001-JN", "A History of Ancient Prague", 35.99, 4, 1);
insert into book (isbn, title, price, author_id, id) values ("002-JN", "A People's History", 40.99, 4, 2);
insert into book (isbn, title, price, author_id, id) values ("001-MJ", "The Beatles Anthology", 11.22, 1, 3);
insert into book (isbn, title, price, author_id, id) values ("001-OG", "Carrie", 23.99, 2, 4);
