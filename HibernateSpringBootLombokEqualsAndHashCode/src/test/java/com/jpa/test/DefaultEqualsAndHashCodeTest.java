...
public class DefaultEqualsAndHashCodeTest {

    @Autowired
    private TestEntityManager entityManager;

    private static final DefaultProduct product = new DefaultProduct();
    private static final Set<DefaultProduct> products = new HashSet<>();    
    ...
    public void C_givenProductWhenMergeThenSuccess() {
        ...
        DefaultProduct mergedProduct = entityManager.merge(product);
        entityManager.flush();
    ...
    public void D_givenProductWhenFindThenSuccess() {
        ...
        DefaultProduct foundProduct = entityManager
                .find(DefaultProduct.class, product.getId());
        entityManager.flush();
