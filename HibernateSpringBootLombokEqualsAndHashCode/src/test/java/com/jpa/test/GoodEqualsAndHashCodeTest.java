...
public class GoodEqualsAndHashCodeTest {

    @Autowired
    private TestEntityManager entityManager;

    private static final GoodProduct product = new GoodProduct();
    private static final Set<GoodProduct> products = new HashSet<>();    
    ...
    public void C_givenProductWhenMergeThenSuccess() {
        ...
        GoodProduct mergedProduct = entityManager.merge(product);
        entityManager.flush();
    ...
    public void D_givenProductWhenFindThenSuccess() {
        ...
        GoodProduct foundProduct = entityManager.find(GoodProduct.class, product.getId());
        entityManager.flush();
