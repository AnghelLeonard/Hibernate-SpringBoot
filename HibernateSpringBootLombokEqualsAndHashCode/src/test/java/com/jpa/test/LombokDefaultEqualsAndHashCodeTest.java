...
import com.jpa.LombokDefaultProduct;
...
public class LombokDefaultEqualsAndHashCodeTest {
    ...
    private static final LombokDefaultProduct product = new LombokDefaultProduct();
    private static final Set<LombokDefaultProduct> products = new HashSet<>();    
    ...
    public void C_givenProductWhenMergeThenSuccess() {
        ...
        LombokDefaultProduct mergedProduct = entityManager.merge(product);
        entityManager.flush();
    ...
    public void D_givenProductWhenFindThenSuccess() {
        ...
        LombokDefaultProduct foundProduct = entityManager
                .find(LombokDefaultProduct.class, product.getId());
        entityManager.flush();
