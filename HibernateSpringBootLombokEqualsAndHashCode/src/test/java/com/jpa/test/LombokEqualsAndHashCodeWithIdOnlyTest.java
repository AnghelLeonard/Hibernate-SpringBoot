...
import com.jpa.LombokIdProduct;
...
public class LombokEqualsAndHashCodeWithIdOnlyTest {
    ...
    private static final LombokIdProduct product = new LombokIdProduct();
    private static final Set<LombokIdProduct> products = new HashSet<>();    
    ...
    public void C_givenProductWhenMergeThenSuccess() {
        ...
        LombokIdProduct mergedProduct = entityManager.merge(product);
        entityManager.flush();
    ...
    public void D_givenProductWhenFindThenSuccess() {
        ...
        LombokIdProduct foundProduct = entityManager
                .find(LombokIdProduct.class, product.getId());
        entityManager.flush();
