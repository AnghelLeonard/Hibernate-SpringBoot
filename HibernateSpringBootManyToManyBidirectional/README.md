...
**Key points:**\
     ...
     - as entities identifiers, use an assigned identifier (business key, natural key (`@NaturalId`)) and/or a database-generated identifier and override properly the `equals()` and `hashCode()` methods as [here](https://vladmihalcea.com/the-best-way-to-implement-equals-hashcode-and-tostring-with-jpa-and-hibernate/)\
