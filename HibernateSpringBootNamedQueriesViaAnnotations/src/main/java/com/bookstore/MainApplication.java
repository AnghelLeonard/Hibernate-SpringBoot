...
public class MainApplication {
    ...
    public ApplicationRunner init() {
        return args -> {
            ...
            System.out.println("\nFind all authors order by name descending (native):");
            List<Author> authorsDescNative = bookstoreService.fetchAllAuthorsDescNative();
            authorsDescNative.forEach(System.out::println);   
