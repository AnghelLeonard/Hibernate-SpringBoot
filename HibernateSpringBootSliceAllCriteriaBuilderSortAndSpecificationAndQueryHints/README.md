**[How To Implement `Slice<T> findAll` Via `CriteriaBuilder`, `Sort`, `Specification` And `QueryHints`](https://github.com/AnghelLeonard/Hibernate-SpringBoot/tree/master/HibernateSpringBootSliceAllCriteriaBuilderSortAndSpecificationAndQueryHints)**
