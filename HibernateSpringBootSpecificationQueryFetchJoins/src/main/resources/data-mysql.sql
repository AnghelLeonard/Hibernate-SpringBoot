...
insert into book (isbn, title, author_id, id) values ("001-AT", "Anthology of a Day", 5, 5);
insert into book (isbn, title, author_id, id) values ("002-AT", "Anthology Myths", 5, 6);
insert into book (isbn, title, author_id, id) values ("003-AT", "Wonders of the Anthology", 5, 7);
insert into book (isbn, title, author_id, id) values ("001-KL", "Anthology 999", 6, 8);
insert into book (isbn, title, author_id, id) values ("002-KL", "Extreme Anthology", 6, 9);
