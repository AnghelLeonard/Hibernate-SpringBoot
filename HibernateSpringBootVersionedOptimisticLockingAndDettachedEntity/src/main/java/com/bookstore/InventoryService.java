...
public class InventoryService {
    ...
    public void thirdTransactionIsReattachingAndResultsInOLE(Inventory firstInventory) {
        ...
        try {
            ...
            //Inventory x = entityManager.find(Inventory.class, firstInventory.getId());
            //    x.setName("qqqqqqqqqqqqqqqqqqqqwwwwww");
            q = entityManager.merge(firstInventory);
            //firstInventory = q;
            //firstInventory.setName("dccdddddddddddddddddddddddddddddddddddddddd");
            //q.setName("dccdddddddddddddddddddddddddddddddddddddddd");
            ...
            if (entityTransaction != null && entityTransaction.isActive()) {
                entityTransaction.rollback();
                firstInventory.setVersion(q.getVersion());
            }
