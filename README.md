...
46. **[How To Avoid LazyInitializationEception Via JOIN FETCH](https://github.com/AnghelLeonard/Hibernate-SpringBoot/tree/master/HibernateSpringBootDtoUnrelatedEntities)**
...
**Key points:**\
     ...
     - write a `JOIN FETCH` to fetch all categories including products\
     - write a `JOIN FETCH` to fetch all products including categories
