...
73. **[How To Implement Offset Pagination in Spring Boot](https://github.com/AnghelLeonard/Hibernate-SpringBoot/tree/master/HibernateSpringBootKeysetPagination)**
...
**But:** If *offset* pagination is causing you performance issues then please check recipes: 70 (slice technique for find all records), 71 (*offset* with window functions) and [72](https://github.com/AnghelLeonard/Hibernate-SpringBoot/tree/master/HibernateSpringBootKeysetPagination) (*keyset* pagination).
