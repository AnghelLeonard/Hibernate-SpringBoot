...
**Key points:**\
     ...
     - in case of using a parent-child with cascade persist (e.g. one-to-many) set up `spring.jpa.properties.hibernate.order_inserts=true` to optimize the batching by ordering inserts
